...
namespace AlgorithmCodeKata {
    ...
    // 나중에 다시 코드를 보면서 공부하려고 작성한 코드를 컴퓨터 바탕화면에 아무 위치에나 저장해 둡니다.
    ...
    public class _070_Desktop : KataBase {
        ...
        public override void Example() {
            ...
            Console.WriteLine(solution(wallpaper)[0]);
            Console.WriteLine(solution(wallpaper)[1]);
            Console.WriteLine(solution(wallpaper)[2]);
            Console.WriteLine(solution(wallpaper)[3]);
        }
    }
}
